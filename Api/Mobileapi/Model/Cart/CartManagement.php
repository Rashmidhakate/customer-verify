...
class CartManagement extends \Magento\Framework\Model\AbstractModel implements CartInterface {
    ...
    public function __construct(
        ...
        \Magento\Directory\Model\ResourceModel\Region\CollectionFactory $directoryCollectionFactory        
    ) {
        ...
        $this->directoryCollectionFactory = $directoryCollectionFactory;        
    }
    ...
    public function createAppOrder($Version = '', $Platform= '', $DeviceId= '', $Data) {
        ...
        if (count($Data) > 0 ) {
            ...
            if ($appQuoteData->getOrderId()) {
                ...
                /* setting default address if no address of customer code start*/
                $customer = $this->customerFactory->create()->load($data['CustomerId']);
                $firstname = $customer->getFirstname();
                $lastname = $customer->getLastname();
                $billingAddressId = $customer->getDefaultBilling();
                $shippingAddressId = $customer->getDefaultShipping();
                $regionCode = $this->directoryCollectionFactory->create();
                $regionCode->addFieldToFilter('code',array('eq'=>'CA'));
                ...
                if(!$billingAddressId && !$shippingAddressId){
                    ...
                    ->setTelephone(3235824444)

                    ->setCity('Los Angeles')

                    ->setRegion($regionCode->getData()[0]['region_id'])

                    ->setStreet('2801 E. Vernon.')
                ...
                /* setting default address if no address of customer code ends*/
